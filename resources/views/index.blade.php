...
<head>
	...
	{!! Html::style('html-theme/fonts/ionicons/css/ionicons.min.css')  !!}

	{{--<link rel="stylesheet" href="fonts/font-awesome/css/font-awesome.min.css">--}}
	{!! Html::style('html-theme/fonts/font-awesome/css/font-awesome.min.css') !!}

	<!-- Plugins -->
	{{--<link rel="stylesheet" href="styles/plugins/c3.css">--}}
	{!! Html::style('html-theme/styles/plugins/c3.css') !!}

	{{--<link rel="stylesheet" href="styles/plugins/waves.css">--}}
	{!! Html::style('html-theme/styles/plugins/waves.css') !!}

	{{--<link rel="stylesheet" href="styles/plugins/perfect-scrollbar.css">--}}
	{!! Html::style('html-theme/styles/plugins/perfect-scrollbar.css') !!}

	
	<!-- Css/Less Stylesheets -->
	{{--<link rel="stylesheet" href="styles/bootstrap.min.css">--}}
	{!! Html::style('html-theme/styles/bootstrap.min.css') !!}

	{{--<link rel="stylesheet" href="styles/main.min.css">--}}
	{!! Html::style('html-theme/styles/main.min.css') !!}
...
<body id="app" class="app off-canvas">
	...
	{!! Html::script('html-theme/scripts/plugins/d3.min.js') !!}
	{{--<script src="scripts/plugins/d3.min.js"></script>--}}
	{!! Html::script('html-theme/scripts/plugins/d3.min.js') !!}
	{{--<script src="scripts/plugins/c3.min.js"></script>--}}
	{!! Html::script('html-theme/scripts/plugins/c3.min.js') !!}
	{{--<script src="scripts/plugins/screenfull.js"></script>--}}
	{!! Html::script('html-theme/scripts/plugins/screenfull.js') !!}}
